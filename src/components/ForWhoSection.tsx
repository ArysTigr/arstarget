...
const audiences = [
  { icon: GraduationCap, label: "Онлайн-школы", desc: "Набор учеников и заполнение потоков", gradient: "from-violet/15 to-primary/8", iconColor: "text-violet" },
  { icon: Building2, label: "Локальные услуги", desc: "Запись клиентов и рост выручки", gradient: "from-accent/15 to-cyan/8", iconColor: "text-accent" },
  { icon: ShoppingBag, label: "Интернет-магазины", desc: "Заказы и повторные покупки", gradient: "from-coral/15 to-highlight/8", iconColor: "text-coral" },
];
