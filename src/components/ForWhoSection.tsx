    ...
    <section className="section-padding bg-card">
      <div className="container-narrow">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-5 max-w-3xl mx-auto">
          {audiences.map((item) => (
            <div key={item.label} className="group flex flex-row sm:flex-col items-center gap-3 sm:gap-4 p-4 sm:p-7 bg-background rounded-2xl border border-border/60 hover:border-primary/30 shadow-sm hover:shadow-card-hover transition-all duration-300">
