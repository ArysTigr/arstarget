...
const reviews = [
  ...
  },
  {
    ...
    text: "Мне нужны были записи, а не клики. Зашли через акцию на чистку → пациенты остались на лечение. 38% заявок = реальная запись. Расписание забито на 3 недели.",
    rating: 5,
    result: "38% конверсия",
  },
  {
    ...
    text: "Раньше — только reels и сарафанка. Первый запуск таргета: 270 заказов, окупаемость ×3.1. Арыстан не просто настроил рекламу — переделал оффер, и всё полетело.",
    rating: 4,
  ...
  },
  {
    ...
    text: "Думал, таргет не для локального бизнеса. Ошибался. Гео-таргетинг + правильный оффер = 90+ новых клиентов за месяц. Стоимость привлечения — 800 ₸ при чеке 3 500 ₸.",
    rating: 5,
    result: "90+ клиентов",
  },
];
